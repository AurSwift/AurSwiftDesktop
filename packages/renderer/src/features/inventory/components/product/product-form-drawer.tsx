            ...
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
              ...
              >
                ...
                <div className="border-b bg-background shrink-0">
                  ...
                  <div className="flex space-x-2 px-6 pt-4 pb-4 border-b">
                    <Button
                      type="submit"
                      className="flex-1"
                ...
                <div className="flex-1 min-h-0 overflow-y-auto">
                  <div className="p-6">
                            ...
                            <FormItem className="col-span-2">
                              <FormControl>
                                <AdaptiveFormField
                                  ...
                                  onFocus={() =>
                                    keyboard.handleFieldFocus("name")
                                  }
                                ...
                                <SelectContent>
                                  {!categories || categories.length === 0 ? (
                                    <div className="px-2 py-1.5 text-sm text-muted-foreground">
                                      No categories found - please add a
                                      category first
                                    </div>
                                  ) : (
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) => {
                                    ...
                                    if (checked) {
                                      ...
                                      // When enabling weighted mode, automatically set sales unit to KG if it's PIECE
                                      const currentSalesUnit =
                                        form.getValues("salesUnit");
                                      if (
                                        currentSalesUnit === "PIECE" ||
                                        !currentSalesUnit
                                      ) {
                                        form.setValue("salesUnit", "KG");
                                      }
                                      // Keep basePrice as fallback (required by schema)
                                      // It will be hidden from UI but still stored
                                    } else {
                                      // When disabling weighted mode, clear pricePerKg and reset to PIECE
                                      form.setValue("pricePerKg", 0);
                                      form.setValue("salesUnit", "PIECE");
                                    }
                                  }}
                                  disabled={isSubmitting}
                                />
                                          ...
                                          {isFixedMode ? (
                                            <>
                                              ...
                                              <p className="text-xs text-muted-foreground">
                                                Sales unit is fixed system-wide.
                            ...
                            <FormItem>
                              <FormControl>
                                <AdaptiveFormField
                                  ...
                                  error={
                                    form.formState.errors.stockLevel?.message
                                  }
                                  onFocus={() =>
                    ...
                    <TabsContent value="expiry" className="space-y-4 mt-0">
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mb-4">
                            Configure batch tracking and expiry date management
                            for this product.
                          </p>
                        </div>
                            ...
                            <FormField
                              ...
                              render={() => (
                                <FormItem>
                                  ...
                                  <FormMessage />
                                  <p className="text-xs text-gray-500 mt-1">
                                    Expected number of days before product
                                    expires
                                  </p>
                                </FormItem>
                              )}
                                ...
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                  <div className="space-y-0.5">
                                    ...
                                    <p className="text-xs text-gray-500">
                                      When enabled, stock must be tracked by
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mb-4">
                            ...
                            Age-restricted items require verification at
                            checkout.
                          </p>
                        </div>
                              ...
                              <div className="flex items-start space-x-2">
                                ...
                                <div className="flex-1">
                                  ...
                                  <p className="text-xs text-orange-700">
                                    This product will require age verification
                                    at checkout. Staff must verify the
                                    customer's age before completing the sale.
                                  </p>
                                </div>
                              </div>
                            </div>
