  ...
  return (
    <button
      ...
      className={cn(
        ...
        "min-h-11 min-w-0 w-full px-1.5 py-2 text-xs",
        // License keyboard specific sizing (narrower container - smaller keys)
        "in-[.license-keyboard]:min-h-[38px] in-[.license-keyboard]:min-w-0 in-[.license-keyboard]:px-1 in-[.license-keyboard]:py-1.5 in-[.license-keyboard]:text-xs",
        // Medium screens (md: 768px+)
        "md:min-h-12 md:min-w-0 md:px-2 md:py-2.5 md:text-sm",
        "in-[.license-keyboard]:md:min-h-[42px] in-[.license-keyboard]:md:min-w-0 in-[.license-keyboard]:md:text-xs",
        // Large screens (lg: 1024px+)
        "lg:min-h-[52px] lg:min-w-0 lg:px-2 lg:py-3 lg:text-sm",
        "in-[.license-keyboard]:lg:min-h-[46px] in-[.license-keyboard]:lg:min-w-0 in-[.license-keyboard]:lg:text-sm",
        "font-medium",
